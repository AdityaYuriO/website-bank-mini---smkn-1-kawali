...
<div class="fade-in flex flex-1 flex-col justify-start mb-8">
    ...
    <div class="bg-white rounded-[24px] shadow-card p-6 md:p-10 w-full border border-gray-50">
        <form onsubmit="event.preventDefault(); showToast('Data GTK berhasil disimpan (Mode Preview)', 'success'); setTimeout(() => { window.location.href='{{ url('/admin/supervisor/datanasabah') }}'; }, 1000); return false;" id="formMasterGTK">
