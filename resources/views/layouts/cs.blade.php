    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto w-full">
        ...
        <div class="max-w-[1050px] mx-auto w-full flex flex-col h-full mt-2 pb-10 px-6 lg:px-10">
            ...
            <header class="flex flex-col md:flex-row justify-between items-start md:items-center py-4 lg:py-8 mb-4 gap-4 md:gap-0  hidden lg:flex">
                <div>
                    <h2 class="text-[17px] md:text-[26px] font-bold text-gray-800 mb-0.5">@yield('header_title', 'Selamat Datang!')</h2>
                    <p class="text-gray-500 text-[10px] md:text-[14px]">@yield('header_subtitle', 'Kelola data nasabah dengan mudah.')</p>
                </div>
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-left">
                            <p class="font-bold text-[14px] text-gray-800 leading-tight">{{ auth()->user()->name }}</p>
